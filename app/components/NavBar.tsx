  ...
  return (
    <Navbar fluid rounded className="border-b-2 border-primaryBlue bg-white dark:bg-primaryBlue dark:border-primaryBlue fixed top-0 left-0 right-0 z-50">
                ...
                <Navbar.Collapse className="md:mt-4 lg:mt-0">
                    ...
                    <Link href="/oac" className={pathname === "/oac" ? "text-white bg-primaryBlue hover:bg-primaryBlue focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-primaryBlue dark:hover:primaryBlue focus:outline-none dark:focus:primaryBlue" : "text-pureBlack font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  dark:hover:primaryBlue focus:outline-none dark:focus:primaryBlue"}>
                      O.A.C
                    </Link>
